...
class Order extends Component {
    ...
    IncreasePizza = () => {
        ...
        this.setState({
            totalAmount: (this.state.quantity + 1) * this.props.order.amount
        });
    };
    ...
    ReducePizza = () => {
        this.state.quantity === 1
            ? this.setState({
                  quantityMessage: "Sorry, You cannot buy Zero [0] item"
              })
            : this.Decrement();
    };
                ...
                <Modal {...this.props} size="large">
                    ...
                    <Modal.Content image>
                        ...
                        <Modal.Description>
                            ...
                            <div id="modal-pizzza-details">
                                ...
                                <p>
                                    ...
                                    <Label as="a" color="teal" tag>
                                        {formatPrice(this.props.order.amount)}{" "}
                                    </Label>{" "}
                                </p>
                                <p>
                                    <b>Total Price:</b>{" "}
                                    <Label as="a" color="teal" tag>
                                        {formatPrice(this.state.totalAmount)}
                                    </Label>{" "}
                                </p>
                            </div>
                            ...
                            <Button color="violet" onClick={this.IncreasePizza}>
                                {" "}
                                +{" "}
                            </Button>

                            <Button color="red" onClick={this.ReducePizza}>
                                {" "}
                                -{" "}
                            </Button>
